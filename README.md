...
<modules>
	<module version="0.1">com.pixate.pxengine</module>
</modules>
...
For example,
	...
	var my_module = require('com.pixate.pxengine');
	my_module.foo();
...
To create a module, create a file named com.pixate.pxengine.js under the assets folder.
